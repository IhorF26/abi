...
<div class="site-contact">
    ...
    <?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
        ...
        <div class="alert alert-success">
            Dziękujemy za skontaktowanie się z nami. Będziemy z Państwem odpowiedzieć jak najszybciej.
        </div>
    ...
    <?php else: ?>
        ...
        <p>
            Jeśli masz pytania biznesowe lub inne pytania, wypełnij poniższy formularz, aby się z nami skontaktować. Dziękuję.
        </p>
